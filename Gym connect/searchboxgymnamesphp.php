...
<head>
  ...
  <link href="gymnames.css" rel="stylesheet">
  ...
  <table border="1" cellspacing="0" class="table table-hover">
    ...
    <tbody>
      ...
      if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT category,gym_name,address,city,state,phone_no FROM gym 
                where category like '%$str%' or gym_name like '%$str%' or address like '%$str%' or city like '%$str%' or state like '%$str%'";
